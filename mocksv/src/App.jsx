...
const API_URL =
  "https://69829b249c3efeb892a2bfb9.mockapi.io/api/sinhvien/sinhvien";
...
function App() {
  ...
  return (
    <div className="app-container">
      <h1>Nhóm 10 thứ 4 ca 1 </h1>
      <ul>
        <li>DH52200548 Nguyễn Hoàng Dương D22_TH13</li>
        <li> DH52200813 Võ Thanh Huy D22_TH13 </li>
      ...
      <div className="list-section">
        ...
        <button onClick={fetchItems} className="btn-refresh" disabled={loading}>
